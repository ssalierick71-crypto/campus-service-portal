    ...
    <footer class="bg-[#1e3a8a] text-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
                <div>
                    <div class="flex items-center gap-3 mb-6">
                        <img src="{{ asset('assets/img/logo.png') }}" alt="" class="h-12 w-12">
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-sm text-blue-100">
                        ...
                        <li><a href="{{ route('requests.create') }}" class="hover:text-white">Open a ticket</a></li>
                        <li><a href="{{ route('staff.dashboard') }}" class="hover:text-white">Staff inbox</a></li>
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm text-blue-100">
                        <li><a href="mailto:helpdesk@campus.ac.ug" class="hover:text-white">helpdesk@campus.ac.ug</a></li>
            ...
            <div class="pt-8 border-t border-blue-800 flex flex-col sm:flex-row justify-between items-center gap-4 text-sm text-blue-200">
                <p>© {{ date('Y') }} Campus Service Portal. All rights reserved.</p>
